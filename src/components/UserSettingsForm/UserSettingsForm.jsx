...
// import { fetchUserData, updateUserData } from "../../redux/user-slice";
...
//   const { data: userData, error, loading } = useSelector((state) => state.user);
...
//       setValue("gender", userData.gender || "Woman");
//       setValue("weight", userData.weight || 0);
//       setValue("activeTime", userData.activeTime || 0);
//       setValue("dailyNorm", userData.dailyNorm || 1.8);
//       if (userData.avatarUrl) {
//         setAvatarPreview(userData.avatarUrl);
//       }
//     }
//   }, [dispatch, setValue, userData, userId]);
...
//     try {
//       const response = await dispatch(updateUserData(formData)).unwrap();
//       if (response) {
//         onUpdate(response);
//         onClose();
//       }
